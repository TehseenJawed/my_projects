...
$result22 = $q->query("SELECT * FROM item_reg ");*/
/*$ww=mysqli_fetch_array($result22);*/
require_once('includes/load.php');
  $e="SELECT * from item_reg";
$result22 =  $db->query($e);
$index=1;
...
<h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>Product Details</h1>
         </strong>
        </div>
            ...
            <thead>
               <tr>
                ...
                <th style="color: #6fb6d8">Quantity </th>
                          <th colspan="2" style="text-align: center; color: #6fb6d8">Action </th>
