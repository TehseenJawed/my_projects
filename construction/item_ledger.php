...
$q=new mysqli("localhost","root","","softy");
$result22 = $q->query("SELECT * FROM newitem_reg Where dates BETWEEN '$from_date' AND '$to_date' ");
  ...
  {  
    ?>
              ...
              <td class="text-center"> <?php echo remove_junk($row[1]); ?></td>
               <td class="text-center"> <?php echo remove_junk($row[4]); ?></td>  <td class="text-center">000.00</td>
                <td class="text-center">555.00</td>
