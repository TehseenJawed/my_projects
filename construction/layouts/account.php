...
<!--bank-->
  ...
  <li>
    ...
    <div class="dropdown">
      <div class="wh">
      <b><i>
      <button class="dropbtn"><strong> <i style="color: white;" class="glyphicon glyphicon-folder-open"></i> &nbsp Accounts&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</strong></button>
      </i></b>
      <br> 
