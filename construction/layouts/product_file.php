...
<li>
    ...
    <div class="wh">
            <b><i>
   <strong>  <a href="production_trans.php" style="color: white;margin-left: 24px;"><span style="color: white;" class="glyphicon glyphicon-th"></span><strong> Purchase transaction</a></i></b></a></strong></i>
     <!--  <b><i>
      <button class="dropbtn"><strong> <i class="glyphicon glyphicon-th"></i>  Notifications</a></strong></button> -->
 </i>
</b>
