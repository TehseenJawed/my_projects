...
<?php include_once('layouts/header.php'); ?>
    ...
    <div class="panel-body">
      ...
      <th>Voucher Name</th><td>
        ...
        <select name="voucher_type" class="form-control nam">Voucher type
...
<td>
 <select name="ven_cus_id" class="form-control nam">Vendor/Customer ID
       <?php
...
$query="INSERT into voucher_transaction(voucher_name,voucher_type, voucher_mode, voucher_cat, amount, remarks) VALUES 
('$voucher_name', '$voucher_type', '$voucher_mode', '$voucher_cat', '$amount', '$remarks')";
