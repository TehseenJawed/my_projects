<?php
  ...
  $qqq="SELECT * from bank_pymt_voucher";
  $result=$db->query($qqq);
?>
...
<strong>
           <h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>&nbspBank payment Voucher</h1>
         </strong>
          ...
          <table class="table   table-condensed table-striped  table-hover table-bordered" id="myTable">
            <thead>
              <tr>
                ...
                <th style="color: #6fb6d8""> Currency </th>
