...
print_r($result22->fetch_array(MYSQLI_NUM));
...
<h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>Vendor Ledger Summary</h1>
         </strong>
        </div>
        ...
        <div class="panel-body">
          ...
          <table class="table   table-condensed table-striped  table-hover table-bordered" id="myTable">
            <thead>
              <tr>
                <th style="color: #6fb6d8">Vendor_id </th>
                <th style="color: #6fb6d8"> VEndor_Title </th>
                <th style="color: #6fb6d8"> Opening_Balance </th>
            ...
            <tbody>
              <tr>
              <?php while($row=$result22->fetch_array(MYSQLI_NUM))
 { ?>
            <tr>
