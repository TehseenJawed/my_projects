<?php
 ...
 $ven_name=$_GET['ven_name'];
  ...
  $query = " SELECT SUM(cash)  from  purchase_pro WHERE ven_name='$ven_name'";
     $sql=$db->query($query);
  $cash=$sql->fetch_array(MYSQLI_NUM);
$query1  =" SELECT SUM(due)  from  purchase_pro WHERE ven_name='$ven_name'";
  $sql1=$db->query($query1);
  $due=$sql1->fetch_array(MYSQLI_NUM);
$query3=" SELECT SUM(price)  from  purchase_pro WHERE ven_name='$ven_name'";
  ...
  <div class="row">
    ...
    <div class="col-md-10">
      <div class="panel panel-default">
        ...
        <a href="print_7vendor_details.php?ven_name=<?php echo $_GET['ven_name'];?>"  style="float: right;"><button class="btn btn-success"> <span class="glyphicon glyphicon-download-alt"></span> Print</button></a><br>
