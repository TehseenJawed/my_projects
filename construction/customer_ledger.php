       ...
       <!--  <input class="nam form-control" type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.."> -->
        <div class="panel-body">
          ...
          <table class="table   table-condensed table-striped  table-hover table-bordered" id="myTable">
            <thead>
              <tr>
                <th style="color: #6fb6d8"> Customer_Name </th>
                <th style="color: #6fb6d8">Customer_id </th>
                <th style="color: #6fb6d8"> Opening_Balance </th>
                <th style="color: #6fb6d8"> Voucher_cat </th>
                <th style="color: #6fb6d8"> Ven_cus_id</th>
                <th style="color: #6fb6d8"> Debit</th>
                <th style="color: #6fb6d8"> Invoice_no</th>
                <th style="color: #6fb6d8"> Invoice_id </th>
