  ...
  <div class="col-md-11">
    <div class="qq">
      <div class="panel panel-default">
        ...
        ?>
        <br>
        <a href="print_Completed_Projects.php"  style="float: right;"><button class="btn btn-success"> <span class="glyphicon glyphicon-download-alt"></span> Print</button></a><br>
        <br>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="text-center"> <?php echo $TotalExpense; ?></td>
       ...
       <form action="Completed_Projects.php" method="POST">
       Start Date <input type="date" name="date">
        from Date <input type="date" name="datee">
        <input type="submit" name="btnsb">
      </form>
...
if (isset($_POST['btnsb'])) {
   $date=$_POST['date'];
   @$datee=$_POST['datee'];
$result = $q->query("SELECT * FROM  complete_pro WHERE start_date BETWEEN '$date' AND '$datee'");   
}
else
{
  ...
  ?>
   <td class="text-center"> <?php echo remove_junk($row[0]); ?></td>
                ...
                <td class="text-center"> <?php echo remove_junk($row[8]); ?></td>
                 ...
                 <td>  
           <a href="complete_project_detail.php?id=<?php echo $row[2]?>"   class="btn btn-success">
            Details <span class="glyphicon glyphicon-edit"></a>  </td>
            <td>  
