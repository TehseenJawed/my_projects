...
<?php
  $page_title = 'Bank Payment Vouchar';
		             	...
		             	<tr>
		                  ...
		                  <tr>
		                    ...
		                    <tr>
		             	     ...
		             	     <th>Cheque No.</th>
		             	     <td><input type="text" name="c_no" placeholder="Enter cheque" class="form-control" required/></td>
		             	 </tr>
		             	 <tr>
		                	 <td colspan="4">
...
if(isset($_POST['button']))
{
	...
	$query="INSERT INTO  bank_pymt_voucher(B_name,Account_no,cuurency,date_r,amount,check_no)VALUES('$name',
	'$acount','$cuurency','$date','$amount','$cheque_no')";
