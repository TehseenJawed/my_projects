    ...
    <div class="qq">
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            <h1 style="text-align: center; color:#c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>Employes Details</h1>
         </strong>
        </div>
    <div class="panel-body">
          ...
          <!--      <div class=" table-responsive"> --> 
               <table class="table   table-condensed table-striped  table-hover table-bordered">
                 <tr>
          <td>
        <input class="form-control nam" type="text" id="myInput" onkeyup="myFunction()"  placeholder="Search by salary..">	</td>
        <td>
  ...
  ?>
   <td class="text-center"> <?php echo remove_junk($row[0]); ?></td>
               ...
               <td class="text-center"> <?php echo remove_junk($row[7]); ?></td>
                ...
                <td>  
           <a href="emp_edit.php?id=<?php echo $row[0]?>"   class="btn btn-warning">
            Edit <span class="glyphicon glyphicon-edit"></a>  
             

 <a href="emp_delete.php?id=<?php echo $row[0]?>"  class="btn btn-danger"> Delete <span class="glyphicon glyphicon-trash"></span>  </td>
