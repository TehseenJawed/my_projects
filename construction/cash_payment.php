<?php
  ...
  $qqq="SELECT * from cah_pay_voucher";
  $result=$db->query($qqq);
?>
...
<strong>
           <h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>&nbspCash Payment Voucher</h1>
         </strong>
          ...
          <table class="table   table-condensed table-striped  table-hover table-bordered" id="myTable">
            <thead>
              <tr>
                 ...
                 <th style="color: #6fb6d8""> Pay Name </th>
