...
<h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>All Reminders</h1>
         </strong>
        </div>
          ...
          <table class="table   table-condensed table-striped  table-hover table-bordered" id="myTable">
            <thead>
              <tr>
                ...
                <th style="color: #6fb6d8">Subject</th>
 ...
 { ?>
            ...
            <td>  
           <a href="remind_edit.php?id=<?php echo $row[0]?>"   class="btn btn-success">
            Send email <span class="glyphicon glyphicon-open"></a>
            <a href="remind_delete.php?id=<?php echo $row[0]?>"   class="btn btn-danger">
