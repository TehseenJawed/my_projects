...
$result22 = $q->query("SELECT * FROM new_customer_reg");
...
<h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>Customer Records</h1>
 ...
 { ?>
           ...
           <td>  
           <a href="customer_edit.php?id=<?php echo $row[0]?>"   class="btn btn-warning">
            Edit <span class="glyphicon glyphicon-edit"></a>  
             

 <a href="customer_delete.php?id=<?php echo $row[0]?>"  class="btn btn-danger"> Delete <span class="glyphicon glyphicon-trash"></span>  </td>
