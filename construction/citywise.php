...
$result22 = $q->query("SELECT * FROM invoice i, customer_reg c, city_reg r where r.id= c.City_ID and i.customer_id = '$sale_person_id'");


$q=new mysqli("localhost","root","","softy");
$result22 = $q->query("SELECT * FROM invoice_detail d, invoice i
