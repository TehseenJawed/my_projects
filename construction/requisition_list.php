...
<h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>List of  Requisition</h1>
         </strong>
        </div>
          ...
          <table class="table   table-condensed table-striped  table-hover table-bordered" id="myTable">
            <thead>
              <tr>
                ...
                <th style="color: #6fb6d8">Requisition </th>
               
                <th style="color: #6fb6d8">Note</th>
                
                <th style="color: #6fb6d8">Date</th>
              
                <th style="color: #6fb6d8">Description</th>
                <th style="color: #6fb6d8">Mass Type</th>
                <th style="color: #6fb6d8">Unit</th>
                <th style="color: #6fb6d8">Balance</th>
                <th style="color: #6fb6d8">Quantity</th>
                <th style="color: #6fb6d8">Cost Center</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"><?php echo remove_junk($product['requ']); ?></td>
                <td class="text-center"><?php echo remove_junk($product['note']); ?></td>
               ...
               <td class="text-center"><?php echo remove_junk($product['Mas_ty']); ?></td>
                <td class="text-center"><?php echo remove_junk($product['unit']); ?></td>
                <td class="text-center"><?php echo remove_junk($product['balance']); ?></td>
                <td class="text-center"><?php echo remove_junk($product['qty']); ?></td>
               <td class="text-center"><?php echo remove_junk($product['cost_c']); ?></td>
