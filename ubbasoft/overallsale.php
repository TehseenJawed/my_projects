    ...
    <div class="qq">
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            <h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>Overall Sales report</h1>
         </strong>
...
<br>
<div class="qq">
                  <a href="print_overallsale.php?fd=<?php echo $fd?>&ed=<?php echo $ed?>" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>
<div class="panel panel-default">  
