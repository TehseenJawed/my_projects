...
<th style="color: #6fb6d8"> Op_Bal </th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"> <?php echo remove_junk($product['ven_title']); ?></td>
                <td class="text-center"> <?php echo remove_junk($product['ven_cat_id']); ?></td>

                <td class="text-center"> <?php echo remove_junk($product['v_contact_person']); ?></td>
                <td class="text-center"> <?php echo remove_junk($product['v_designation']); ?></td>
                            <td class="text-center"> <?php echo remove_junk($product['v_address']); ?></td>
