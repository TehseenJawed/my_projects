    ...
    <div class="col-md-10">
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
               <h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;"><span class="glyphicon glyphicon-th"></span>Lc Transaction</h1>
         </strong>
        </div>
        
        <th> <a href="print_lc_transaction.php" class="btn btn-success" style="float: right;" value="Print this page" ><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>  </th>
