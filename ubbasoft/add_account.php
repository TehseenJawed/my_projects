<?php
  ...
  $page_title = 'Account Registratioz';
		...
		<div class="panel-body">
          <form  action="add_bank.php" method="POST" >
            <div class="form-group">
			 ...
			 <strong>
			 <text style= 'margin-left:1px';> <span>Bank ID</span></text>
			 </strong>

			 <input type="text" class="form-control nam" name="bank_id" placeholder="Enter Bank id">
			 	<br>
			 <strong>
