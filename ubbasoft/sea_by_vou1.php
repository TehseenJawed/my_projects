...
<strong>
           <h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>&nbspSupplier Payment Report</h1>
         </strong>
         

     
          <form action="sea_by_vou1.php" method="post" >
        ...
        <div class="panel-body">
          ...
          <table class="table   table-condensed table-striped  table-hover table-bordered" id="myTable">
            ...
            <tbody>
              ...
              ?>
                  <a href="sea_by_print1.php?i=<?php echo $inv1; ?>" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>

                <?php

               $query="SELECT * FROM vendor_payment i, newvendor_reg k, addbank l WHERE voucher_no = '$inv1' and k.id = i.vendor_name and i.bank_name =  l.bank_id";
               include 'config.php' ;
              ...
              <tr>
                ...
                <td class="text-center"> <?php echo remove_junk($product['21']); ?></td>
