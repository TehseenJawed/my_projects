<?php
  $page_title = 'Date Wise Customer Recipt Details';
...
<strong>
           <h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>&nbspDate Wise Customer Recipt Details</h1>
         </strong>
         
        </div>

 <div class="panel-body">
          <form action="datewise_details.php" method="post" >
 ...
 <td>
    ...
    <td> <input type="text" name="inv1" class="form-control nam" placeholder="Invoice Number"> </td>
            ...
            <thead>
              <tr>
                <th style="color: #6fb6d8"">#</th>
                 <th style="color: #6fb6d8""> Code </th>
                <th style="color: #6fb6d8""> Customer Name  </th>
                <th style="color: #6fb6d8""> V.No </th>
                 <th style="color: #6fb6d8""> V.Date </th>
                <th style="color: #6fb6d8""> Cash </th><!--
                <th style="color: #6fb6d8""> T.Price </th>
                <th style="color: #6fb6d8""> MRP </th>
                <th style="color: #6fb6d8""> OPB </th>                          <th style="color: #6fb6d8"> Prod Convention </th>
 -->                <th style="color: #6fb6d8"> Cheque </th>
            ...
            <a href="datewise_print.php?i=<?php echo $inv1; ?>" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>
            
            <?php

              $query="SELECT * FROM receieve_customer n, customer_reg r WHERE n.customer_id = r.id and n.  voucher_id='$inv1'";
               include 'config.php' ;
              ...
              <tr>
                ...
                <td class="text-center"> <?php echo remove_junk($product['8']); ?></td>
           ...
           <a href="datewise_print1.php?from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>


            <?php


              $query="SELECT * FROM receieve_customer n, customer_reg r WHERE n.customer_id = r.id and n.date BETWEEN '$from_date' AND '$to_date'";
               include 'config.php' ;
              $products=mysqli_query($conn,$query);
              while($product=mysqli_fetch_array($products)) 
              {
