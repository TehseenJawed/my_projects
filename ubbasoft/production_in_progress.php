...
<h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>Production Summary Ledger</h1>
     ...
     <tr>
      ...
      <td><input type="checkbox" name="overall" value="overall">Over all</td>
     ...
     <td colspan="2">
       ...
       <a href="print_production_in_progress.php" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>
