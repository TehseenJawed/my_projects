   ...
   <div class="col-md-11">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            <h1 style="text-align: center; color: #c4cfe4;  text-shadow: 2px 2px 5px green;"><span class="glyphicon glyphicon-th"></span>Customer Recipt</h1>
         </strong>
        </div>
    ...
    <div class="panel-body">
          <form action="receieve_from_customer.php" method="post" >
...
$query="INSERT into receieve_customer(customer_id, amount, voucher_mode, remarks, bank_name, account_no, check_no, date, voucher_id) VALUES ('$ven_cus_id', '$amount', '$voucher_mode', '$remarks', '$bank_name', '$acc_num', '$check_num', '$dates', '$vouchernoo')";

$query2= "UPDATE addaccount set amount=amount +'$amount' where account_no='$acc_num'";

     $query1="UPDATE invoice_pay SET payment_paid= payment_paid+'$amount',payment_remaining= payment_remaining-'$amount' WHERE custom_id='$ven_cus_id'";

    

 
     if($db->query($query) && $db->query($query1)  && $db->query($query2) ){
        echo '<script language="javascript">';
    echo 'alert("Successfully Registered"); location.href="receieve_from_customer.php"';
    echo '</script>';
     } else {
        echo '<script language="javascript">';
    echo 'alert("Registeration Failed"); location.href="receieve_from_customer.php"';
    echo '</script>';
     }
...
window.location.href="receieve_from_customer.php?vc_id="+myName;
