...
?>
          ...
          <form action="sea_by_inv_1.php" method="post" >
          ...
          <table class="table   table-condensed table-striped  table-hover table-bordered" id="myTable">
            <thead>
              <tr>
                ...
                <th style="color: #6fb6d8""> Sales Person </th>
            ...
            <tbody>
              ...
              if (isset($_POST['btn1'])) {
               ...
               $query="SELECT * FROM invoice i, customer_reg k, newvendor_reg l, sales s WHERE 
               i.invoice_no = '$inv_no' and l.id = i.sale_person_id and i.customer_id = k.id";
               include 'config.php' ;
              ...
              <tr>
                ...
                <td class="text-center"> <?php echo remove_junk($product['13']); ?></td>
                <td class="text-center"> <?php echo remove_junk($product['25']); ?></td>
