...
<strong>
            <h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>&nbspAll Products Report</h1>
         </strong>
          <a href="print_allproducts.php" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>
          ...
          <table class="table   table-condensed table-striped  table-hover table-bordered" id="myTable">
            <thead>
              <tr>
                ...
                <th style="color: #6fb6d8""> Unit Price </th>
                <th style="color: #6fb6d8""> Ex-Factory </th>
