 ...
 <div class="row">
   ...
   <div class="col-md-8">
    ...
    <div class="panel-body">
          <form action="personwise.php" method="post" >
               <table class="table   table-condensed table-striped  table-hover table-bordered">
     <tr>
       <th>FROM Date</th>
       <td>
       <input type="Date" class="form-control nam" name="from_date" placeholder="From Date" required="required">
        </td>
     ...
     `
       <th>TO Date</th>
       <td>
       <input type="Date" class="form-control nam" name="to_date" placeholder="To Date" required="required">
        </td>
      </tr>
      <tr>
      ...
      <th>Person wise</th>
      <td>
        <select name="sale_person_id" class="form-control nam">Person Name
...
<div class="qq">
  <a href="print_personwise.php?fd=<?php echo $fd?>&ed=<?php echo $ed?>&spid=<?php echo $spid?>" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>
<div class="panel panel-default">
