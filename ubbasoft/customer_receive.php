<?php
  $page_title = 'Customer Recivable Summary';
...
<strong>
           <h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>&nbspCustomer Recivable Summary</h1>
         </strong>
         

       <div class="panel-body">
          <form action="customer_receive.php" method="post" >
          ...
          <table class="table   table-condensed table-striped  table-hover table-bordered" id="myTable">
            <thead>
              <tr>
                ...
                <th style="color: #6fb6d8""> Customer Address </th>
            ...
            <tbody>
              ...
              if (isset($_POST['btn1'])) {
                ...
                ?>
                  <a href="customer_res_print.php?i=<?php echo $inv1; ?>" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>

                <?php

                $inv1=$_POST['ven_cus_id'];
              
               $query="SELECT * FROM customer_reg r, invoice_pay n WHERE n.custom_id = r.id and 
               r.customer_name = '$inv1'";
               include 'config.php' ;
            ...
            $to_date=$_POST['to_date'];
              ?>
                  <a href="customer_res_print1.php?from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>

                <?php
               $query="SELECT * FROM customer_reg r, invoice_pay n WHERE n.custom_id = r.id and 
               r.date BETWEEN '$from_date' AND '$to_date'";
               include 'config.php' ;
              $products=mysqli_query($conn,$query);
              while($product=mysqli_fetch_array($products)) 
              {
