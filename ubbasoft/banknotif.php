...
$result22 = $conn->query("SELECT * FROM cm_addcheque");

/*$ww=mysqli_fetch_array($result22);*/
$index=1;


  $page_title = 'Bank Notification';
...
<h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>Bank Notifications</h1>
         </strong>
        </div>
