    ...
    <div class="qq">
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            <h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>City wise report</h1>
         </strong>
        </div>
    <div class="panel-body">
          <form action="citywise.php" method="post" >
     ...
     <tr>
       ...
       <input type="Date" class="form-control nam" name="to_date" placeholder="To Date">
        ...
        <select name="sale_person_id" class="form-control nam">Province Name
          <option value="--select Province--" >--Selected City--</option>
...
?>
<div class="qq">
    <a href="print_citywise.php?fd=<?php echo $fd?>&ed=<?php echo $ed?>&spid=<?php echo $spid?>" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span> Print</a>
<div class="panel panel-default">
...
inner join customer_reg c, city_reg r 
where i.invoice_no = d.invoice_id 
and i.customer_id = c.id
and c.City_ID= r.id
and r.id = '$sale_person_id'
