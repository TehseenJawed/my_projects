 ...
 <ul>  <li>
  <text class = "chk">
    ...
    <ul>
     ...
     <li>
  <text class = "chk">
    <a href="m_edit_production.php">
     <i class="glyphicon glyphicon-user"></i>
     <span> Production Trans  </span> 
  </a>
  </text>
    ...
    <ul>
     ...
     <li>
  <text class = "chk">
    <a href="m_edit_purchase.php">
     <i class="glyphicon glyphicon-user"></i>
     <span> Purchase Trans  </span> 
  </a>
  </text>
