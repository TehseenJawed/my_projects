   ...
   <div class="div_1">
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            <h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>Add cheque amount</h1>
         </strong>
        </div>
...
<td colspan="2">
 <button type="submit" name="submitcheque"  class="btn btn-primary form-control" >Register</button>
</td>
</tr>
</table>
