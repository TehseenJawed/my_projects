...
<strong>
           <h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>&nbspPurchase Invoice</h1>
         </strong>
         

       <div class="panel-body">
          <form action="purchase_invoice.php" method="post" >
        ...
        <div class="panel-body">
          ...
          <table class="table   table-condensed table-striped  table-hover table-bordered" id="myTable">
            ...
            <tbody>
              ...
              ?>
                  <a href="purchase_print.php?i=<?php echo $inv1; ?>" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>

                <?php


               $query="SELECT * FROM purchase_trans WHERE vendor_id = '$inv1' ";
               include 'config.php' ;
              ...
              <tr>
               ...
               <!-- <td class="text-center"> <?php echo remove_junk($product['29']); ?></td> -->
            ...
            $to_date=$_POST['to_date'];
                ...
                ?>
                  <a href="purchase_print1.php?from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>

                <?php



               $query="SELECT * FROM purchase_trans WHERE  
               p_date BETWEEN '$from_date' AND '$to_date'";
               include 'config.php' ;
              $products=mysqli_query($conn,$query);
              while($product=mysqli_fetch_array($products)) 
              {
