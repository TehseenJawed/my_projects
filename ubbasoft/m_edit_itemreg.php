            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <div class="btn-group">
                    <a href="n_edit_itemreg.php?id=<?php echo (int)$product['id'];?>" class="btn btn-info btn-xs"  title="Edit" data-toggle="tooltip">
                      <span class="glyphicon glyphicon-edit"> EDIT </span>
                    </a>
                    <a href="delete_itemreg.php?id=<?php echo (int)$product['id'];?>" class="btn btn-danger btn-xs"  title="Delete" data-toggle="tooltip">
