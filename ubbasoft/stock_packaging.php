...
<?php include_once('layouts/header.php'); ?>
  ...
  <div class="row">
    ...
    <a href="print_stock_packaging.php" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>
          ...
          <table class="table   table-condensed table-striped  table-hover table-bordered" id="myTable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"><!-- <?php echo remove_junk($product['product_type']); ?>-->Packaging</td>
