...
<strong>
           <h1 style="text-align: center; color: #c4cfe4; text-shadow: 2px 2px 5px green;" ><span class="glyphicon glyphicon-th"></span>&nbspOBP Product</h1>
         </strong>
         <a href="print_opb_products.php" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>
        </div>
 ...
 -->                <th style="color: #6fb6d8"> Quantity </th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"> <?php echo remove_junk($product['product_type']); ?></td>
