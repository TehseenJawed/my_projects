  ...
  <div class="row">
    ...
    <div class="col-md-10">
      <div class="panel panel-default">
        ...
        <th> <a href="print_newinvoice_trans.php" class="btn btn-success" style="float: right;" value="Print this page" ><span class="glyphicon glyphicon-open"></span>&nbspPrint</a>  </th>
    <script>document.writeln("  <br> ");</script>
    
    <div class="panel-body">
          <form action="nninvoiceret.php" method="post" >
            <div class="form-group">
                <div class=" table-responsive">
               <table class="table   table-condensed table-striped  table-hover table-bordered">
                <tr>
                
                <th>Invoice Ret. No. </th>
                <td>
...
$query="INSERT INTO invoice_return(invoice_ret_date, customer_id, ref_no, sale_person_id, remarks)VALUES('$dc_date','$customer_id', '$ref_no','$sales_person_id', '$remarks')";
...
$conn->query("INSERT INTO invoice_return_detail  
SET   

invoice_ret_id = '{$_POST['invoice_no']}', 
...
$queryt="TRUNCATE table temp_sale";
     ...
     {
        echo '<script language="javascript">';
        echo 'alert("Registeration Failed"); location.href="nninvoiceret.php"';
        echo '</script>';
     }
